      ...
      <article className="post-content page-template no-image">
        <div className="post-content-body">
          ...
          <ul className="actions">
            <li>
              <a
                href="https://drive.google.com/file/d/1QxqoulPDDOqmTqzzYycB9FE9eEXpWW3y/view?usp=sharing"
                download
        ...
        <div id="cabecera">
          <div class="imagen-cabecera">
            <a href="/content/assets/whatsapp.png"></a>1
          </div>
          <div class="imagen-cabecera">
            <a href="/content/assets/whatsapp.png"></a>2
          </div>
        </div>
      </article>
    </Layout>
